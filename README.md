...
Full Backup: Creates a complete copy of the source folder to a specified destination, organizing backups into dated folders.

Incremental Backup: Copies only new or modified files since the last full backup by comparing source and backup contents. Includes a menu for option selection.
